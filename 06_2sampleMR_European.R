...
cad <- fread(".../CardiogramC4D-UKBB_CAD_sumstats.txt",
                  header = TRUE, stringsAsFactors = FALSE, data.table = FALSE) 

#read metabolite summary stats
meta <- fread(".../METSIM-CLSA_metabolite_sumstats.txt",
             header = TRUE, stringsAsFactors = FALSE, data.table = FALSE)
...
#clump instruments
dat <- clump_data(dat, clump_r2 = 0.05, clump_p1 = 5e-08, clump_kb = 1000, pop = "EUR")
